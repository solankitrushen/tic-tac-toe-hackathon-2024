...
const allowedFileTypes = ["application/pdf"]; // MIME type for PDF
...
const storage = multerS3({
  ...
  acl: AWS_ACL,
  key: (req, file, cb) => {
    const uploadPath = "openSourceBook";
...
export default uploadBooksToS3;
